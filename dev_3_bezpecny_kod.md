...
- doložení a ověření identifikačních informací (e.g. pro web předáme údaje o identitě a instalujeme _Certbot_, nebo nahrajeme určitý soubor, abychom dokázali, že máme nad serverem kontrolu)
...
- **Fuzzing** - program spouštíme s _náhodnými_ generovanými vstupy a sledujeme výstupy
  - vhodné pro blackbox
